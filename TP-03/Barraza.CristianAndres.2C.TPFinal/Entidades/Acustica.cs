...
namespace Entidades
{
    ...
    public class Acustica : Guitarra,IAmplificacion,IProduccion
    {
        ...
        {
            if (ValidarControlStock(StockElementos.encordadosDaddarioAcustica, 1))
            {
        ...
        {
            if (ValidarControlStock(StockElementos.ecualizador, 1) && ValidarControlStock(StockElementos.clavijerosTresMasTres, 1) && ValidarControlStock(StockElementos.encordadosDaddarioAcustica, 1))
            {
