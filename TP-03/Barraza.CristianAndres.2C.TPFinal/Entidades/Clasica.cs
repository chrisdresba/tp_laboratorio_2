...
namespace Entidades
{
    public class Clasica : Guitarra,IAmplificacion,IProduccion
    {
        ...
        {
            if (this.Clavijas is EClavijeros.Clasica && ValidarControlStock(StockElementos.clavijerosClasica, 1))
            {
                StockElementos.clavijerosClasica -= 1;
                return true;
            }
        ...
        {
            if (ValidarControlStock(StockElementos.encordadosDaddarioClasica, 1))
            {
        ...
        {
            if (ValidarControlStock(StockElementos.ecualizador, 1) && ValidarControlStock(StockElementos.clavijerosClasica, 1) && ValidarControlStock(StockElementos.encordadosDaddarioClasica, 1))
            {
