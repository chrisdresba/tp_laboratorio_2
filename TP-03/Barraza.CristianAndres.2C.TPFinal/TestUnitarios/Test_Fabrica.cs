...
namespace TestUnitarios
{
    ...
    public class Test_Fabrica
    {
        ...
        /// <summary>
        /// Test del metodo ReducirMicrofonos
        /// </summary>
        [TestMethod]

        public void ProbarReducirMicrofonos()
        {
            bool respuesta;
            Electrica electrica = new Electrica(EMicrofonos.TresSimple, "Stratocaster SB45", EClavijeros.SeisEnLinea, EColor.Azul, ECuerdas.ErnieBallElectrica);
            //ARRANGE
            ...
            //ACT
            respuesta = electrica.ReducirMicrofonos();
            ...
            //ACT
            respuesta = electrica.ReducirMicrofonos(); // Debe dar False ya que debe descontar Tres microfonos y solo hay dos
