...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            clasica1 = new Clasica(EEq.Si, "Ad335Eq",EClavijeros.Clasica,EColor.Natural,ECuerdas.DaddarioClasica);
            clasica2 = new Clasica(EEq.No, "Am120", EClavijeros.Clasica, EColor.Negro, ECuerdas.DaddarioClasica); 
